  ...
  return (
    <div className="bg-[#ffffff] overflow-hidden w-full max-w-none relative">
      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        {/* Newsletter Section */}
        <section className="w-full bg-[#f8f9fa] py-[80px] px-[100px] mb-[116px] rounded-[20px]">
          <div className="max-w-[1340px] mx-auto flex gap-[82px] items-center">
            <img
              className="w-[536px] h-[357px] object-cover flex-shrink-0"
              alt="Newsletter illustration"
              src="/image-81.svg"
            />
            <div className="flex flex-col flex-1">
              <div className="[font-family:'Inter',Helvetica] font-medium text-[#393939] text-xl tracking-[0] leading-[22.8px] whitespace-nowrap mb-[24px]">
                Get Our Weekly
              </div>
              <div className="max-w-[664px] [font-family:'Inter',Helvetica] font-semibold text-[#87127c] text-[70px] tracking-[0] leading-[70px] mb-[24px]">
                Newsletter
              </div>
              <div className="w-[81px] h-[5px] bg-[#87127c] mb-[40px]" />
              <div className="max-w-[761px] [font-family:'Poppins',Helvetica] font-normal text-[#5a5a5a] text-xl tracking-[-0.20px] leading-[30px] mb-[60px]">
              ...
              <div className="w-[552px] h-14 flex relative">
                <Input
                  className="w-[539px] h-14 bg-[#ffffff] rounded-[50px] border-[0.5px] border-solid border-[#b6b6b6] pl-[25px] text-[#999999]"
                  placeholder="Email Address"
                />
                <Button className="absolute right-0 top-0 w-[146px] h-14 bg-[#87127c] rounded-[50px] shadow-[0px_1px_12px_transparent] h-auto hover:bg-[#87127c]/90">
        ...
        <div className="w-full bg-[#f8f9fa] rounded-[20px] overflow-hidden relative mx-auto mb-[116px] py-[80px] px-[100px]">
          {/* Background decorative lines */}
          <div className="absolute inset-0 overflow-hidden">
            {/* Left side curved lines */}
            <svg className="absolute left-[50px] top-[100px] w-[300px] h-[300px]" viewBox="0 0 300 300" fill="none">
              <path d="M50 50 Q150 100 250 50" stroke="#e0e0e0" strokeWidth="1" fill="none" opacity="0.5"/>
              <path d="M30 80 Q130 130 230 80" stroke="#e0e0e0" strokeWidth="1" fill="none" opacity="0.5"/>
              <path d="M70 120 Q170 170 270 120" stroke="#e0e0e0" strokeWidth="1" fill="none" opacity="0.5"/>
            </svg>
            
            {/* Right side curved lines */}
            <svg className="absolute right-[50px] bottom-[100px] w-[300px] h-[300px]" viewBox="0 0 300 300" fill="none">
              <path d="M50 250 Q150 200 250 250" stroke="#e0e0e0" strokeWidth="1" fill="none" opacity="0.5"/>
              <path d="M30 220 Q130 170 230 220" stroke="#e0e0e0" strokeWidth="1" fill="none" opacity="0.5"/>
              <path d="M70 180 Q170 130 270 180" stroke="#e0e0e0" strokeWidth="1" fill="none" opacity="0.5"/>
            </svg>
          </div>

          <div className="max-w-[1340px] mx-auto flex gap-[100px] items-center relative z-10">
            <div className="flex-1 max-w-[653px]">
              <div className="flex flex-col items-start gap-6">
                ...
                <div className="max-w-[653px] [font-family:'Roboto',Helvetica] font-normal text-[#050505] text-[22px] tracking-[0] leading-[35px]">
              ...
              <div className="mt-[60px] w-[426px] h-[62px] flex gap-[32.8px]">
                <img
            ...
            <img
              className="w-[400px] h-[500px] object-contain flex-shrink-0"
